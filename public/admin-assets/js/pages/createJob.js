...
const FormValidator = new FormValidation(createJobForm, formValidationDetails);
createJobForm.addEventListener("submit", (event) => {
    ...
    let formData = new FormData(createJobForm);
    formData.delete("requirements__tags");
    const formDataObject = Object.fromEntries(formData);
    const http = new EasyHTTP();
    const apiFormAction = createJobForm.dataset.secondaryAction;
