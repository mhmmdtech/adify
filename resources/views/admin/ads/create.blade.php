...
@push('script-tags')
    ...
    <script defer src="{{ asset('admin-assets/js/pages/createAd.js') }}"></script>
...
@section('content')
    ...
    <section class="w-100 mg-top-1">
        <form id="create-ad-form"
            ...
            method="post" enctype="multipart/form-data" action="{{ route('admin.ads.store') }}"
            data-secondary-action="{{ route('api.admin.ads.store') }}">
            @csrf
            ...
            <div class="w-100-lt-576 w-50-gt-576 d-flex flex-column mg-top-1 job-form__input-group" data-input-group>
                ...
                <span
                    ...
                    <select
                        ...
                        <option value=""></option>
                        <option value="1" @if (old('salary') == 1) selected @endif>مشخص نیست</option>
                        <option value="2" @if (old('salary') == 2) selected @endif>توافقی</option>
                        <option value="3" @if (old('salary') == 3) selected @endif>کمتر از ۱۰ میلیون تومان
                        </option>
                        <option value="4" @if (old('salary') == 4) selected @endif>بین ۱۰ تا ۲۰ میلیون تومان
                        </option>
                        <option value="5" @if (old('salary') == 5) selected @endif>بین ۲۰ تا ۵۰ میلیون تومان
                        </option>
                        <option value="6" @if (old('salary') == 6) selected @endif>بیش از ۵۰ میلیون تومان
                        </option>
                    </select>
                </span>
            ...
            <div class="w-100-lt-576 w-50-gt-576 d-flex flex-column mg-top-1 job-form__input-group" data-input-group>
                ...
                <span
                    ...
                    <select
                        ...
                        <option value=""></option>
                        <option value="1" @if (old('seniority') == 1) selected @endif>مشخص نیست</option>
                        <option value="2" @if (old('seniority') == 2) selected @endif>کارآموز</option>
                        <option value="3" @if (old('seniority') == 3) selected @endif>تازه‌کار</option>
                        <option value="4" @if (old('seniority') == 4) selected @endif>میانی</option>
                        <option value="5" @if (old('seniority') == 5) selected @endif>ارشد</option>
                    </select>
                </span>
            ...
            <div class="w-100-lt-576 w-50-gt-576 d-flex flex-column mg-top-1 job-form__input-group" data-input-group>
                ...
                <span
                    ...
                    <select
                        ...
                        <option value=""></option>
                        <option value="1" @if (old('work_type') == 1) selected @endif>مشخص نیست</option>
                        <option value="2" @if (old('work_type') == 2) selected @endif>دورکاری</option>
                        <option value="3" @if (old('work_type') == 3) selected @endif>حضوری</option>
                        <option value="4" @if (old('work_type') == 4) selected @endif>هیبریدی</option>
                    </select>
                </span>
            ...
            <div class="w-100-lt-576 w-50-gt-576 d-flex flex-column mg-top-1 job-form__input-group" data-input-group>
                ...
                <input type="text" name="ad_url" id="ad_url"
                    ...
                    data-error-name="منبع آگهی" value="{{ old('ad_url') }}" />
            ...
            <div class="w-100 d-flex flex-column mg-top-1 job-form__input-group" data-input-group>
                ...
                <textarea name="explanation" id="explanation" cols="30" rows="10"
                    ...
                    data-error-name="توضیحات">{{ old('explanation') }}</textarea>
