...
@push('script-tags')
    ...
    <script defer src="{{ asset('admin-assets/js/pages/createJob.js') }}"></script>
...
@section('content')
    ...
    <section class="w-100 mg-top-1">
        <form id="create-job-form"
            ...
            method="post" enctype="multipart/form-data" action="{{ route('admin.jobs.store') }}"
            data-secondary-action="{{ route('api.admin.jobs.store') }}">
            @csrf
            <div class="w-100 d-flex flex-column mg-top-1 job-form__input-group" data-input-group>
                ...
                <input type="text" name="job_title" id="job_title" placeholder="جاوااسکریپت"
                    ...
                    data-error-name="عنوان نیازمندی" value="{{ old('job_title') }}" />
            ...
            <div class="w-100 d-flex flex-column mg-top-1 job-form__input-group" data-input-group>
                <label class="text-capitalize mg-bottom-half mg-left-half color-primary job-form__label"
                    for="requirements">نیازمندی‌های این شغل
                </label>
                <span
                    ...
                    <input type="hidden" name="requirements" id="requirements" value="{{ old('requirements') }}"
                        data-error-name="نیازمندی‌های این شغل" />
