...
@push('script-tags')
    ...
    <script defer src="{{ asset('admin-assets/js/pages/createCompany.js') }}"></script>
@endpush
...
@section('content')
    ...
    <section class="w-100 mg-top-1">
        <form id="create-company-form"
            ...
            method="post" enctype="multipart/form-data" action="{{ route('admin.companies.store') }}"
            data-secondary-action="{{ route('api.admin.companies.store') }}">
            @csrf
